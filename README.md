The development code for this project is provided for free by the IBM Instana team. The project, named Robot Shop, is an E-commerce platform that utilizes a three-tier architecture. It features 8 microservices developed in Java, Node.js, Go, Python, and PHP. Additionally, it includes two databases (MySQL and MongoDB) and utilizes Redis as an in-memory data store.

I have created a complete deployment pipeline for this project which includes:

- Creation of an Azure Virtual Machine.

- Building Docker images for each microservice using Docker Compose.

- Utilizing Helm YAML files as a package manager for Kubernetes.

- Deploying into AKS (Azure Kubernetes Service) Kubernetes containers.

- Configuring an Ingress controller for traffic management.

- Exposing the project to end users.
